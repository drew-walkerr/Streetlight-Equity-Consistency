...
new_census_linear_covariates <- lm(percent_visited~new_census + census_count + volunteers_on_shift, data = new_census_overall_reach_by_date)

summary(new_census_linear)
summary(new_census_linear_covariates)
new_census_linear
# add model using volunteers_per_day as covariate
